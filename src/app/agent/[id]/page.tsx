...
export default function AgentDetailPage({ params }: { params: { id: string } }) {
  ...
  const agentReviews = reviews.filter((r) => r.agentId === params.id);
          ...
          <div className="md:col-span-1">
            <Card className="sticky top-24">
              <CardContent className="p-6 text-center">
                ...
                <h1 className="text-3xl font-bold font-headline">{agent.name}</h1>
                <p className="text-muted-foreground mt-1">{agent.specialty}</p>
                ...
                <Button size="lg" className="w-full mt-6">
                    Hire Agent <MessageCircle className="ml-2 h-5 w-5" />
                </Button>
              </CardContent>
            </Card>
          </div>
